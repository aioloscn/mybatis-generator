...
/**
 * @author Aiolos
 * @date 2021/1/23 10:18 上午
 */
public class JavaTypeResolverTinyintToIntegerImpl implements JavaTypeResolver {
    ...
    public JavaTypeResolverTinyintToIntegerImpl() {
        super();
        ...
        typeMap.put(Types.VARCHAR, new JavaTypeResolverDefaultImpl.JdbcTypeInformation("VARCHAR", //$NON-NLS-1$
                new FullyQualifiedJavaType(String.class.getName())));
        // JDK 1.8 types
        typeMap.put(TIME_WITH_TIMEZONE, new JavaTypeResolverDefaultImpl.JdbcTypeInformation("TIME_WITH_TIMEZONE", //$NON-NLS-1$
                new FullyQualifiedJavaType("java.time.OffsetTime"))); //$NON-NLS-1$
        typeMap.put(TIMESTAMP_WITH_TIMEZONE, new JavaTypeResolverDefaultImpl.JdbcTypeInformation("TIMESTAMP_WITH_TIMEZONE", //$NON-NLS-1$
